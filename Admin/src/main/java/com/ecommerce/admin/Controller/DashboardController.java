...
public class DashboardController {
    ...
    public String home(Model model, Principal principal) throws JsonProcessingException {
        ...
        String dailyEarningJson = getDailyEarningJson(dailyEarnings);
    ...
    private static String getDailyEarningJson(List<Object[]> dailyEarnings) throws JsonProcessingException {
